package de.jordanmruczynski.backend;
...
import de.jordanmruczynski.backend.repository.MovieRepository;
import de.jordanmruczynski.backend.repository.ScreeningRepository;
import de.jordanmruczynski.backend.repository.ScreeningRoomRepository;
...
public class TicketBookingApplication {
	...
	CommandLineRunner runner(MovieRepository movieRepository, ScreeningRepository screeningRepository, ScreeningRoomRepository screeningRoomRepository, SeatRepository seatRepository) {
		return args -> {
			...
			// SCREENINGS
			screeningRepository.save(new Screening(1, movie1, room1, LocalDateTime.of(2023, 11, 10, 15, 0, 0)));
			screeningRepository.save(new Screening(2, movie2, room2, LocalDateTime.of(2023, 11, 10, 20, 0, 0)));
			screeningRepository.save(new Screening(3, movie3, room3, LocalDateTime.of(2023, 11, 10, 13, 0, 0)));
			screeningRepository.save(new Screening(4, movie1, room1, LocalDateTime.of(2023, 11, 10, 10, 0, 0)));
